...
export const DOCTORS: Doctor[] = [
  {
    slug: "dr-juan-francisco-ramirez",
    initials: "JR",
    name: "Dr. Juan Francisco Ram\u00edrez",
  ...
  },
  {
    ...
    role: "Diagn\u00f3stico y Psicoterapia breve sist\u00e9mica",
    color: "orange",
  ...
  },
  {
    ...
    bio: "Pediatra con alta especialidad en Atenci\u00f3n Integral a Ni\u00f1os con S\u00edndrome de Down. Acompa\u00f1a a familias desde el diagn\u00f3stico con un enfoque integral, m\u00e9dico y humano, coordinando el plan de atenci\u00f3n con el equipo transdisciplinario de \u00d3rbita para que cada ni\u00f1o reciba el seguimiento completo que necesita.",
  ...
  },
  {
    ...
    bio: "Neur\u00f3loga pediatra dedicada al diagn\u00f3stico y manejo de condiciones neurol\u00f3gicas en ni\u00f1os y adolescentes: epilepsia, cefaleas, trastornos del movimiento, tics y seguimiento de patolog\u00edas del sistema nervioso. Su pr\u00e1ctica trabaja en coordinaci\u00f3n cercana con pediatr\u00eda del desarrollo y el resto del equipo para ofrecer un abordaje integrado.",
    specialties: ["Epilepsia", "Cefaleas", "Trastornos del movimiento", "Neurolog\u00eda infantil"],
  },
  {
