...
Esa incertidumbre es real. Y es más común de lo que crees: aproximadamente el 7% de los niños en México presenta alguna alteración del lenguaje ([UNAM/DGCS](https://www.dgcs.unam.mx/boletin/bdboletin/2018_571.html), 2018). No es un número menor. Pero tampoco significa que cada variación sea motivo de alarma.
...
Según datos del NIDCD (National Institute on Deafness and Other Communication Disorders), 1 de cada 14 niños entre 3 y 17 años en Estados Unidos presenta algún trastorno de voz, habla o lenguaje ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Conocer los hitos esperados te permite saber qué observar en cada etapa, sin comparaciones injustas.
...
El grupo de edad con mayor prevalencia de trastornos del habla y lenguaje es el de 3 a 6 años, con un 10.8% afectado, la cifra más alta entre todos los rangos etarios ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Esto significa que las señales tempranas importan, porque es en esa ventana donde la intervención tiene más impacto.
...
Según datos del NIDCD, los niños varones tienen casi el doble de probabilidad de presentar trastornos del habla y lenguaje: 9.1% frente a 5.2% en niñas ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Esta diferencia es consistente en múltiples estudios y culturas.
...
Aproximadamente 1 de cada 14 niños (7.2%) entre 3 y 17 años experimenta un trastorno de voz, habla o lenguaje ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Muchos papás imaginan que la terapia de lenguaje se parece a una clase escolar. La realidad es muy distinta, y eso es bueno.
...
Los niños varones son casi dos veces más propensos que las niñas a tener trastornos del habla o lenguaje: 9.1% contra 5.2% ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Independientemente del género, hay momentos claros en los que la espera ya no es la mejor estrategia.
...
Si a los 18 meses tu hijo no dice ninguna palabra, es momento de consultar. El 10.8% de los niños entre 3 y 6 años presenta trastornos del habla o lenguaje, la prevalencia más alta entre todos los grupos de edad ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Consultar temprano no es exagerar. Es actuar en la ventana de mayor impacto.

### ¿Es verdad que los niños hablan más tarde que las niñas?

Hay evidencia de que los niños varones tienen mayor prevalencia de trastornos del habla: 9.1% frente a 5.2% en niñas ([NIDCD/NIH](https://www.nidcd.nih.gov/health/statistics/quick-statistics-voice-speech-language), 2016). Pero eso no significa que debas ignorar señales de alerta en un niño solo porque "es varón". La vigilancia activa aplica para todos.
...
El 7% de los niños en México presenta alteraciones del lenguaje ([UNAM/DGCS](https://www.dgcs.unam.mx/boletin/bdboletin/2018_571.html), 2018). Detrás de ese número hay familias reales con preguntas reales. Familias como la tuya.
